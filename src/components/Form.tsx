...
const Form: FunctionComponent<FormType> = ({ className = "", onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <form
        onSubmit={onSubmit}
        className={`w-full max-w-[840px] bg-white overflow-hidden flex flex-col items-center justify-center text-center text-45xl text-white font-gotham ${className}`}
      >
        <div className="w-full max-w-[840px] bg-nero-1-findora box-border flex flex-col items-center justify-center py-[30px] px-[20px] border-[4px] border-solid border-nero-3-findora relative">
